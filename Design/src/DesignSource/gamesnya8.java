 ...
 * @author BO
 */
public class gamesnya8 extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(gamesnya8.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
