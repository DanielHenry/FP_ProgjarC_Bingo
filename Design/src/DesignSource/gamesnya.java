 ...
 * @author BO
 */
public class gamesnya extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(gamesnya.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
